...
const DEFAULT_GLOW_COLOR = '255, 184, 0'; // Ghumo Gold (RGB)
...
const MagicBento: React.FC<MagicBentoProps> = ({
  ...
  const displayCards = cards || defaultCardData;
      ...
      <BentoCardGrid gridRef={gridRef}>
        {displayCards.map((card, index) => {
          ...
          const cardProps = {
            ...
            style: {
              backgroundColor: card.color || 'rgba(20, 26, 48, 0.6)',
            ...
            return (
              ...
              >
                ...
                <div className="magic-bento-card__body">
                  ...
                  {card.customContent && (
                    <div className="magic-bento-card__custom">
                      {card.customContent}
                    </div>
                  )}
                </div>
