...
class InfiniteGridMenu {
  ...
  discInstances!: { matricesArray: Float32Array; matrices: Float32Array[]; buffer: WebGLBuffer | null };
  running = true;
...
const defaultItems: InfiniteMenuItem[] = [
  {
    ...
    description: 'Paradise of snow-capped mountains and tranquil houseboats.'
  }
];
...
export const InfiniteMenu: React.FC<InfiniteMenuProps> = ({
  ...
  return (
    <div
      className={`infinite-menu-wrapper ${className}`}
      style={{
        position: 'relative',
        width: '100%',
        height: '100%',
      ...
      {activeItem && (
        <div className="infinite-menu-overlay">
          <div className={`face-title ${isMoving ? 'inactive' : 'active'}`}>
            <span className="face-eyebrow">DESTINATION</span>
